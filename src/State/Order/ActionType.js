...
export const DELETE_ORDER_REQUEST='CONFIRM_ORDER_REQUEST';
export const DELETE_ORDER_SUCCESS='CONFIRM_ORDER_SUCCESS';
export const DELETE_ORDER_FAILURE='CONFIRM_ORDER_FAILURE';