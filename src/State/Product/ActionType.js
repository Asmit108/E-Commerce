...
export const CREATE_PRODUCT_REQUEST='DELETE_PRODUCT_REQUEST';
export const CREATE_PRODUCT_SUCCESS='DELETE_PRODUCT_SUCCESS';
export const CREATE_PRODUCT_FAILURE='DELETE_PRODUCT_FAILURE';
